...
export default function AdminDashboard({ onLogout }) {
  ...
  const createShipment = async (e) => {
    ...
    const shipmentDetails = {
      ...
      trackingUrl: `https://globalaxislogistics.online/#tracking/`
    }
          ...
          {activeTab === 'register' && (
            <div>
              ...
              <form onSubmit={createUser} className="max-w-2xl">
                ...
                <button
                  type="submit"
                  className="bg-cyan-500 hover:bg-cyan-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer"
                >
              ...
              <form onSubmit={createShipment} className="max-w-2xl">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <select value={selectedUser} onChange={(e) => setSelectedUser(e.target.value)} required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none text-sm">
                ...
                <button
                  type="submit"
                  className="bg-cyan-500 hover:scale-105 text-white px-8 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer"
                >
                  <i className="ri-add-line mr-2"></i>
                  Create Shipment
                </button>
